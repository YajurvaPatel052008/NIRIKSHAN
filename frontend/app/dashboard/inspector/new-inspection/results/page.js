      ...
      <div className="lg:pl-64">
        ...
        <main className="mx-auto max-w-[1400px] p-5 sm:p-8">
          ...
          <div className="grid gap-6 xl:grid-cols-[0.82fr_1.18fr]">
            <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm"><div className="mb-5"><p className="text-xs font-bold uppercase tracking-[0.14em] text-[#168cae]">Source image</p><h2 className="mt-1 text-base font-bold text-[#0f3d63]">Detected text regions</h2></div><div className="flex min-h-[320px] items-center justify-center rounded-lg border border-dashed border-slate-300 bg-slate-50 p-6 text-center text-sm text-slate-500">Source image evidence will appear here when the analysis service returns a stored image URL.</div></section>
